...
```{r, engine='r'}
deseq2.colData <- data.frame(condition=factor(c(rep("control", 2), rep("26.C", 2), rep("30.C", 2))), 
                             type=factor(rep("paired", 24)))
rownames(deseq2.colData) <- colnames(data#/change this to name of folder, look up how to do)
